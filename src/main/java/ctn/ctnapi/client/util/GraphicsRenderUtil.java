package ctn.ctnapi.client.util;
...
public class GraphicsRenderUtil {
	 ...
	 * @param yPoints          Y坐标数组
	 * @param zPoints          Z坐标数组
	 * @param xePoints         扩展X坐标数组
	 * @param yePoints         扩展Y坐标数组
	 * @param zePoints         扩展Z坐标数组
	 * @param red              红色分量
	 * @param green            绿色分量
	 * @param blue             蓝色分量
	 * @param alpha            透明度分量
	 ...
	 * @param v4y              第四个顶点Y坐标
	 * @param v4z              第四个顶点Z坐标
	 * @param v1eX             第一个扩展顶点X坐标
	 * @param v1eY             第一个扩展顶点Y坐标
	 * @param v1eZ             第一个扩展顶点Z坐标
	 * @param v2eX             第二个扩展顶点X坐标
	 * @param v2eY             第二个扩展顶点Y坐标
	 * @param v2eZ             第二个扩展顶点Z坐标
	 * @param v3eX             第三个扩展顶点X坐标
	 * @param v3eY             第三个扩展顶点Y坐标
	 * @param v3eZ             第三个扩展顶点Z坐标
	 * @param v4eX             第四个扩展顶点X坐标
	 * @param v4eY             第四个扩展顶点Y坐标
	 * @param v4eZ             第四个扩展顶点Z坐标
	 * @param red              红色分量
	 * @param green            绿色分量
	 * @param blue             蓝色分量
	 * @param alpha            透明度分量
